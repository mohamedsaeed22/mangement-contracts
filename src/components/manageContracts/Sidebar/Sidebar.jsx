...
const Default = () => {
  ...
  let folderEle =
    '<div class= "e-folder"><div class= "e-folder-name">Webmail</div></div>';
  let userNameEle = '<div><div class= "e-user-name">John</div></div>';
  let imageEle =
    '<div class= "image-container"><img height="20px" src="src/sidebar/images/user.svg" alt="John"></img></div>';
    ...
    <div className="control-section" id="sidebar-wrapper">
      ...
      >
        <TreeViewComponent
          id="defaultTree"
          fields={treeFields}
          nodeSelecting={beforeSelect.bind(this)}
